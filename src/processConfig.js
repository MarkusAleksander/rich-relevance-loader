...
export default function processConfig(config) {
    ...
    // * check placements are valid, and add the dom to the placement
    let placements = config.placements.filter((placement) => {
        ...
        // * store dom selection for later use
        placement.placement_el = dom_el;
    ...
    // * store updated placements back in config
